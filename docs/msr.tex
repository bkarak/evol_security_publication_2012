...
versions of all the projects that exist in the Maven repoistory (265GB of
data). Then we observed the changes that involved the security bugs and their
characteristics, per project version.

We chose to focus our study on the security-related bugs rather than other
software bugs for a number of reasons.
