...
the repository (multiple versions for every project, dependencies) we studied
the evolution of security bugs through time and their relationship with the
size of the corresponding artifact and other bug categories. Also, based on the
dependencies of artifacts we constructed the graph of the repository and
studied the most popular nodes in terms of their PageRank. 
\end{abstract}
