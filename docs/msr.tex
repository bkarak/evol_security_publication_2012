...
that highlight the relationship between software bugs and evolution. The key
idea behind this concept is typically similar to ours: the combination of
information like bug decriptions, documentation and others with the information
retrieved from either the source or object code of a project version.
