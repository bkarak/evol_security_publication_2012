...
should eliminate them.
	\item The relation of security bugs to the artifact's size.  Here, size is
defined in terms of bytecode.
	\item Security bug persistense between versions. We check if specific bugs are
eliminated between versions.
	\item The correlation of security bugs with other bug categories. We
present how such bugs are correlated with bugs that have to do with
