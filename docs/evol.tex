...
%across project revisions.
	\item Examine security bug persistence between versions. 
...
Our hypothesis is that security bugs flock together with bugs that
have to do with performance, coding practices and others.
...
bug Make available a carefully constructed dataset and a statistical toolkit for
    performing analysis of the Java Maven ecosystem.
categories existing in a large ecosystem. Finally, we highlighted the
