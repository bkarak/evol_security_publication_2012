...
security bugs are not eliminated between releases.
...
Our experiment involved four entities:
...
terms of bytecode. We have to mention that the versions examined were
...
the relation between severe security bugs and a project's size is different
...
Future work on our approach involves the observation of other ecosystems, that
serve different languages, in the same manner. For instance, Python's PyPY
