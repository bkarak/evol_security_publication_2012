...
grouped the persistence numbers by bug categories and then performed
both descriptive statistics and a Mann-Whitney U test among all bug
category pairs. The results are presented in
Table~\ref{tbl:bug_persistence}. Cells in brackets show pairs where no
