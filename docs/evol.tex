...
We explored te relation between defects with the size of a project,
measured by the size of its jar file by carrying out correlation tests
...
\begin{table}
    \centering
    \caption{Correlations between jarsize and Defects Count}
