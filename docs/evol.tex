...
\keywords{Security Bugs, Static Analysis, Software Evolution, Software
...
not have to know anything about the application internals. For almost
all the other security bugs (coming from the {\it Malicious Code}
category and the rest of the {\it Security} category bugs),
...
{\it Security High} category are related with
user-input validation issues. Hence, even if a programmer adds
code to a new version, if this code does not requires user
