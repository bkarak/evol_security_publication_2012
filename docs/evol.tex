...
weekest correlations with the other categories. In general though, the
results show then that bugs do flock together: we do not find projects
with only a certain kind of bug; bugs come upon projects in swarms of
different kinds.
\begin{table}
